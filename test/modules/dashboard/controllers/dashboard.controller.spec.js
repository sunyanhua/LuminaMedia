...
const dashboard_controller_1 = require("../../../../src/modules/dashboard/controllers/dashboard.controller");
const dashboard_service_1 = require("../../../../src/modules/dashboard/services/dashboard.service");
describe('DashboardController', () => {
    ...
    beforeEach(async () => {
        ...
        dashboardController = module.get(dashboard_controller_1.DashboardController);
    ...
    describe('getDashboardStats', () => {
        it('should return dashboard statistics', async () => {
            ...
            expect(dashboardService.getDashboardStats).toHaveBeenCalledWith(mockQuery);
    ...
    describe('getCustomerOverview', () => {
        it('should return customer overview for a profile', async () => {
            ...
            dashboardService.getCustomerOverview.mockResolvedValue(mockOverview);
            const result = await dashboardController.getCustomerOverview(mockParams);
            expect(dashboardService.getCustomerOverview).toHaveBeenCalledWith(profileId);
    ...
    describe('getMarketingPerformance', () => {
        it('should return marketing performance for a campaign', async () => {
            ...
            dashboardService.getMarketingPerformance.mockResolvedValue(mockPerformance);
            const result = await dashboardController.getMarketingPerformance(mockParams, granularity);
            expect(dashboardService.getMarketingPerformance).toHaveBeenCalledWith(campaignId, granularity);
    ...
    describe('getRealTimeMetrics', () => {
        it('should return real-time metrics', async () => {
            ...
            dashboardService.getRealTimeMetrics.mockResolvedValue(mockMetrics);
        ...
        it('should use default lastMinutes when not provided', async () => {
            ...
            dashboardService.getRealTimeMetrics.mockResolvedValue(mockMetrics);
            const result = await dashboardController.getRealTimeMetrics(mockQuery);
            expect(dashboardService.getRealTimeMetrics).toHaveBeenCalledWith(undefined);
            expect(result).toEqual(mockMetrics);
        });
    });
    describe('chart endpoints', () => {
        ...
        it('getUserActivityChart should return chart data', async () => {
            ...
            dashboardService.getUserActivityChart.mockResolvedValue(mockChartData);
            const result = await dashboardController.getUserActivityChart(mockQuery);
            expect(dashboardService.getUserActivityChart).toHaveBeenCalledWith(7, 'profile-123');
            expect(result).toEqual(mockChartData);
        });
        it('getConsumptionDistributionChart should return chart data', async () => {
            const mockQuery = { profileId: 'profile-123' };
            dashboardService.getConsumptionDistributionChart.mockResolvedValue(mockChartData);
            const result = await dashboardController.getConsumptionDistributionChart(mockQuery);
            expect(dashboardService.getConsumptionDistributionChart).toHaveBeenCalledWith('profile-123');
            expect(result).toEqual(mockChartData);
        });
        it('getGeographicDistributionChart should return chart data', async () => {
            const mockQuery = { profileId: 'profile-123' };
            dashboardService.getGeographicDistributionChart.mockResolvedValue(mockChartData);
            const result = await dashboardController.getGeographicDistributionChart(mockQuery);
            expect(dashboardService.getGeographicDistributionChart).toHaveBeenCalledWith('profile-123');
            expect(result).toEqual(mockChartData);
        });
        it('getROITrendChart should return chart data', async () => {
            const mockQuery = { campaignId: 'campaign-123' };
            dashboardService.getROITrendChart.mockResolvedValue(mockChartData);
            const result = await dashboardController.getROITrendChart(mockQuery);
            expect(dashboardService.getROITrendChart).toHaveBeenCalledWith('campaign-123');
            expect(result).toEqual(mockChartData);
        });
        it('getCustomerScatterChart should return chart data', async () => {
            const mockQuery = { profileId: 'profile-123' };
            dashboardService.getCustomerScatterChart.mockResolvedValue(mockChartData);
            const result = await dashboardController.getCustomerScatterChart(mockQuery);
            expect(dashboardService.getCustomerScatterChart).toHaveBeenCalledWith('profile-123');
            expect(result).toEqual(mockChartData);
        });
        it('getCustomerRadarChart should return chart data', async () => {
            const mockQuery = { profileId: 'profile-123' };
            dashboardService.getCustomerRadarChart.mockResolvedValue(mockChartData);
            const result = await dashboardController.getCustomerRadarChart(mockQuery);
            expect(dashboardService.getCustomerRadarChart).toHaveBeenCalledWith('profile-123');
            expect(result).toEqual(mockChartData);
        });
        it('getHeatmapChart should return chart data', async () => {
            const mockQuery = { days: 7, profileId: 'profile-123' };
            dashboardService.getHeatmapChart.mockResolvedValue(mockChartData);
            const result = await dashboardController.getHeatmapChart(mockQuery);
            expect(dashboardService.getHeatmapChart).toHaveBeenCalledWith(7, 'profile-123');
            expect(result).toEqual(mockChartData);
        });
    });
    describe('generateDashboardReport', () => {
        it('should generate dashboard report', async () => {
            ...
            dashboardService.generateDashboardReport.mockResolvedValue(mockResponse);
            const result = await dashboardController.generateDashboardReport(mockBody);
            expect(dashboardService.generateDashboardReport).toHaveBeenCalledWith(mockBody);
    ...
    describe('exportDashboardData', () => {
        it('should export dashboard data', async () => {
            ...
            dashboardService.exportDashboardData.mockResolvedValue(mockResponse);
        ...
        it('should use default format when not provided', async () => {
            ...
            dashboardService.exportDashboardData.mockResolvedValue(mockResponse);
            const result = await dashboardController.exportDashboardData(mockQuery);
            expect(dashboardService.exportDashboardData).toHaveBeenCalledWith(undefined);
            expect(result).toEqual(mockResponse);
        });
    });
    describe('getParkingSpendingChart', () => {
        it('should return parking spending data', async () => {
            ...
            dashboardService.getParkingSpendingData.mockResolvedValue(mockData);
            const result = await dashboardController.getParkingSpendingChart(profileId);
            expect(dashboardService.getParkingSpendingData).toHaveBeenCalledWith(profileId);
    ...
    describe('getTrafficTimeSeriesChart', () => {
        it('should return traffic time series data', async () => {
            ...
            dashboardService.getTrafficTimeSeriesData.mockResolvedValue(mockData);
            const result = await dashboardController.getTrafficTimeSeriesChart(profileId, days);
            expect(dashboardService.getTrafficTimeSeriesData).toHaveBeenCalledWith(profileId, days);
            expect(result).toEqual(mockData);
        });
    });
});
