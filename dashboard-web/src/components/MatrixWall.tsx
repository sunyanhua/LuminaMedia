...
import { Platform, PlatformIdToEnum, PlatformDisplayName, isPlatformSupportedForContentGeneration } from '../types/platform'
...
const MatrixWall = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'connected':
        return <span className="badge badge-success">已连接</span>
      case 'disconnected':
        return <span className="badge badge-error">未连接</span>
      case 'needs_sync':
        return <span className="badge badge-warning">需同步</span>
      default:
        return <span className="badge badge-error">未知</span>
    }
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-white">矩阵管理墙</h2>
          <p className="text-gray-400 mt-1">多平台账号绑定、状态监控与内容同步管理</p>
        </div>
          ...
          return (
            <div key={platform.id} className="card card-hover">
              ...
              <div className="mt-4 flex space-x-2">
                <button
                  className={`flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-colors ${platform.status === 'connected'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">总粉丝数</p>
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">本月发布</p>
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">平均互动率</p>
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">账号健康度</p>
      ...
      {/* Recent Activity */}
      <div className="card">
        <h3 className="text-lg font-semibold text-white mb-6">最近平台活动</h3>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-800">
                <th className="py-3 px-4 text-left text-gray-400 font-medium">平台</th>
                <th className="py-3 px-4 text-left text-gray-400 font-medium">操作类型</th>
              ...
              {recentActivities.map((activity, index) => (
                <tr key={index} className="border-b border-gray-800/50 hover:bg-gray-900/30">
                  <td className="py-3 px-4">
                    <span className="badge badge-warning">{activity.platform}</span>
                  </td>
      ...
      {/* Connection Tips */}
      <div className="card bg-gradient-to-r from-deep-blue-900/30 to-transparent border-deep-blue-800">
        <div className="flex items-start justify-between">
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">提升矩阵效率建议</h3>
          ...
          <button className="btn-primary whitespace-nowrap">查看详细建议</button>
        </div>
      </div>
